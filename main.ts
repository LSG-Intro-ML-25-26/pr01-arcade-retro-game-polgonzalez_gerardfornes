...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Trampolin, function (sprite, otherSprite) {
    if (nena) {
        nena.vy = -250
        if (nena.vx > 0) {
            nena.vx = 250
...
let mySprite20260124T233407695Z = sprites.create(assets.image`barco venezuela`, SpriteKind.Player)
tiles.placeOnTile(mySprite20260124T233407695Z, tiles.getTileLocation(245, 10))
// PERSONAJES
