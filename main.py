...
def on_on_update():
    global nena, bot, distancia3, velocidad3, bot_mirando_derecha
...
menu_inicial()
mySprite20260125T134651507Z = sprites.create(assets.image("""
    mapausa
    """), SpriteKind.player)
mySprite20260125T134728160Z = sprites.create(assets.image("""
    cara feliz
    """), SpriteKind.player)
mySprite20260125T134758921Z = sprites.create(assets.image("""
    madurobros
    """), SpriteKind.player)
mySprite20260125T134842073Z = sprites.create(assets.image("""
        maduropurple
        """),
    SpriteKind.player)
mySprite20260125T134908703Z = sprites.create(assets.image("""
    pokemon
    """), SpriteKind.player)
mySprite20260125T134927886Z = sprites.create(assets.image("""
    trumpworld
    """), SpriteKind.player)
mySprite20260125T135119119Z = sprites.create(assets.image("""
    mapa grande
    """), SpriteKind.player)